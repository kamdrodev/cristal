<template>
  <div class="row">
    <div
      class="col-xs-12 col-sm-12 offset-md col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3"
    >
      <q-select
        outlined
        class="q-mb-md"
        v-model="listsQueryOptions.firstLanguage"
        :options="languages"
        @input="changeQueryOptions"
        label="I know..."
      />
      <q-select
        outlined
        ...
        <form c>
          ...
          <q-card-section class="q-pt-none">
            ...
            <q-select
              ...
              class="q-pb-lg"
              :error="$v.formCreateList.firstLanguage.$error"
            >
            ...
            <q-select
              ...
              class="q-pb-lg"
              :error="$v.formCreateList.secondLanguage.$error"
            >
              <template v-slot:prepend>
                <q-icon name="event" />
              </template>
            ...
            <q-input
              filled
              v-model="formCreateList.title"
              label="Title"
              :error="$v.formCreateList.title.$error"
              class="q-pb-lg"
            >
              <template v-slot:prepend>
                <q-icon name="mail" />
            ...
            <q-input
              filled
              v-model="formCreateList.description"
              label="Description"
              :error="$v.formCreateList.description.$error"
              class="q-pb-lg"
            >
              <template v-slot:prepend>
                <q-icon name="mail" />
      ...
      <q-card style="min-width: 350px;">
        <form c>
          ...
          <q-card-section class="q-pt-none">
            ...
            <q-input
              filled
              v-model="formUpdateList.title"
              label="Title"
              :error="$v.formUpdateList.title.$error"
              class="q-pb-lg"
            >
              <template v-slot:prepend>
                <q-icon name="mail" />
            ...
            <q-input
              filled
              v-model="formUpdateList.description"
              label="Description"
              :error="$v.formUpdateList.description.$error"
              class="q-pb-lg"
            >
              <template v-slot:prepend>
                <q-icon name="mail" />
...
export default {
  ...
  async created() {
    try {
      const getAllListsProcess = await this.$store.dispatch(
        'lists/getAllLists',
        {
      ...
      this.$q.notify({
        message: getAllListsProcess.message,
        color: 'positive',
      });
    } catch (e) {
  ...
  methods: {
    ...
    async createList() {
      try {
        ...
        const createListProcess = await this.$store.dispatch(
          'lists/createList',
          {
        ...
        this.$q.notify({
          message: createListProcess.message,
          color: 'positive',
        });
      } catch (e) {
        this.$q.notify({ message: e.message, color: 'negative' });
    ...
    async updateList() {
      try {
        ...
        const updateListProcess = await this.$store.dispatch(
          'lists/updateList',
          {
        ...
        this.$q.notify({
          message: updateListProcess.message,
          color: 'positive',
        });
      } catch (e) {
        this.$q.notify({ message: e.message, color: 'negative' });
    ...
    async deleteList() {
      try {
        const deleteListProcess = await this.$store.dispatch(
          'lists/deleteList',
          {
        ...
        this.$q.notify({
          message: deleteListProcess.message,
          color: 'positive',
        });
      } catch (e) {
        this.$q.notify({ message: e.message, color: 'negative' });
